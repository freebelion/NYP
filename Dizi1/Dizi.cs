...
namespace Dizi1
{
    ...
    internal class Dizi
    {
        ...
        public void Ekle(double d)
        {
            if (ElemanSayisi == Kapasite)
            { KapasiteArttir(); }
            _array[ElemanSayisi] = d;
            ElemanSayisi++;
        }
        ...
        /// fonksiyon.
        /// </summary>
        /// <param name="d">Aranan değer</param>
        /// <returns></returns>
        public int? SiraNo(double d)
        {
            // İçeriğini siz yazın.
        }
        ...
        /// <param name="d">Yeni eleman değeri</param>
        public void Ekle(int sirano, double d)
        {
            // İçeriğini siz yazın.
